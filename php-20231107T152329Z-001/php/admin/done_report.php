...
if (isset($_POST["btn_clicked"]) && $_POST["btn_clicked"] === "1") {
    $query = "SELECT D_ASIG,
        SUM(CASE WHEN (D_documentType = 'TOR for board exam' OR D_documentType_2 = 'TOR for board exam' OR D_documentType_3 = 'TOR for board exam') THEN D_numCopies ELSE 0 END) AS TOR,
        SUM(CASE WHEN (D_documentType = 'TOR for reference' OR D_documentType_2 = 'TOR for reference' OR D_documentType_3 = 'TOR for reference') THEN D_numCopies ELSE 0 END) AS TOR1,
        SUM(CASE WHEN (D_documentType = 'TOR for copy school' OR D_documentType_2 = 'TOR for copy school' OR D_documentType_3 = 'TOR for copy school') THEN D_numCopies ELSE 0 END) AS TOR2,
        SUM(CASE WHEN (D_documentType = 'Certificate of Unit Earned' OR D_documentType_2 = 'Certificate of Unit Earned' OR D_documentType_3 = 'Certificate of Unit Earned') THEN D_numCopies ELSE 0 END) AS CU,
        SUM(CASE WHEN (D_documentType = 'Certificate of Enrollment' OR D_documentType_2 = 'Certificate of Enrollment' OR D_documentType_3 = 'Certificate of Enrollment') THEN D_numCopies ELSE 0 END) AS CER,
        SUM(CASE WHEN (D_documentType = 'Certificate of Graduation' OR D_documentType_2 = 'Certificate of Graduation' OR D_documentType_3 = 'Certificate of Graduation') THEN D_numCopies ELSE 0 END) AS ER,
        SUM(CASE WHEN (D_documentType = 'Certificate of Grades' OR D_documentType_2 = 'Certificate of Grades' OR D_documentType_3 = 'Certificate of Grades') THEN D_numCopies ELSE 0 END) AS TER,
        SUM(CASE WHEN (D_documentType = 'Certificate of Enrolled Semester' OR D_documentType_2 = 'Certificate of Enrolled Semester' OR D_documentType_3 = 'Certificate of Enrolled Semester') THEN D_numCopies ELSE 0 END) AS MER,
        SUM(CASE WHEN (D_documentType = 'Certificate of English Proficiency' OR D_documentType_2 = 'Certificate of English Proficiency' OR D_documentType_3 = 'Certificate of English Proficiency') THEN D_numCopies ELSE 0 END) AS SER,
        SUM(CASE WHEN (D_documentType = 'Certificate of NSTP Serial Number' OR D_documentType_2 = 'Certificate of NSTP Serial Number' OR D_documentType_3 = 'Certificate of NSTP Serial Number') THEN D_numCopies ELSE 0 END) AS SOR,
        SUM(CASE WHEN (D_documentType = 'Certificate of Honor' OR D_documentType_2 = 'Certificate of Honor' OR D_documentType_3 = 'Certificate of Honor') THEN D_numCopies ELSE 0 END) AS MOR,
        SUM(CASE WHEN (D_documentType = 'Subject Description' OR D_documentType_2 = 'Subject Description' OR D_documentType_3 = 'Subject Description') THEN D_numCopies ELSE 0 END) AS SUB,
        SUM(CASE WHEN (D_documentType = 'Authentication' OR D_documentType_2 = 'Authentication' OR D_documentType_3 = 'Authentication') THEN D_numCopies ELSE 0 END) AS AUT,
        SUM(CASE WHEN (D_documentType = 'CAV' OR D_documentType_2 = 'CAV' OR D_documentType_3 = 'CAV') THEN D_numCopies ELSE 0 END) AS CAV,
        SUM(CASE WHEN (D_documentType = 'HONOROBALE DISMISSAL' OR D_documentType_2 = 'HONOROBALE DISMISSAL' OR D_documentType_3 = 'HONOROBALE DISMISSAL') THEN D_numCopies ELSE 0 END) AS HD,
        SUM(CASE WHEN (D_documentType = 'FORM - 137' OR D_documentType_2 = 'FORM - 137' OR D_documentType_3 = 'FORM - 137') THEN D_numCopies ELSE 0 END) AS CD,
        SUM(CASE WHEN (D_documentType = 'diploma' OR D_documentType_2 = 'diploma' OR D_documentType_3 = 'diploma') THEN D_numCopies ELSE 0 END) AS Diploma,
        SUM(D_numCopies + D_numCopies_2 + D_numCopies_3) AS TOTAL_COPIES
        FROM done
        WHERE D_documentType IN ('TOR For Board Exam', 'FORM - 137', 'CAV', 'HONOROBALE DISMISSAL', 'TOR For Reference', 'Subject Description', 'Authentication', 'Certificate of Honor', 'Certificate of NSTP Serial Number', 'Certificate of English Proficiency', 'TOR For Copy School', 'Certificate of Enrolled Semester', 'Certificate of Graduation', 'Certificate of Unit Earned', 'Certificate of Grades', 'diploma', 'Certificate of Enrollment')
        GROUP BY D_ASIG";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($lastDownloadDateStr === $currentDateStr) {
                ...
                <table style="border: 1px solid black; ">
                    <tr>
                        <td style="color: white; background-color:#17A2B8;" colspan="20"><h2>'.$title.'</h2></td>
                    </tr>
                    <tr>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr text-align: center;>
                            <td style="border:1px solid gray;" colspan="2">' . $row["D_ASIG"] . '</td>
                        ...
                        <tr>
                            ...
                            <tr text-align: center;>
                                ...
                                <td></td>
                                    ...
                                    $output .= '
                                    <tr text-align: center;>
                                    <td style="color:red;"> This request has already been released:</td>
                                    </tr>
                                        ';
                    }
                    ...
                    header('Content-Disposition: attachment; filename=Generate-Released-Document-request.xls');
                    echo $output;
                    exit;
                } else {
