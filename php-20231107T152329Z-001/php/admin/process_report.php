...
if (isset($_POST["btn_clicked"]) && $_POST["btn_clicked"] === "1") {
    $query = "SELECT O_ASIG,
        SUM(CASE WHEN (O_documentType = 'TOR for board exam' OR O_documentType_2 = 'TOR for board exam' OR O_documentType_3 = 'TOR for board exam') THEN O_numCopies ELSE 0 END) AS TOR,
        SUM(CASE WHEN (O_documentType = 'TOR for reference' OR O_documentType_2 = 'TOR for reference' OR O_documentType_3 = 'TOR for reference') THEN O_numCopies ELSE 0 END) AS TOR1,
        SUM(CASE WHEN (O_documentType = 'TOR for copy school' OR O_documentType_2 = 'TOR for copy school' OR O_documentType_3 = 'TOR for copy school') THEN O_numCopies ELSE 0 END) AS TOR2,
        SUM(CASE WHEN (O_documentType = 'Certificate of Unit Earned' OR O_documentType_2 = 'Certificate of Unit Earned' OR O_documentType_3 = 'Certificate of Unit Earned') THEN O_numCopies ELSE 0 END) AS CU,
        SUM(CASE WHEN (O_documentType = 'Certificate of Enrollment' OR O_documentType_2 = 'Certificate of Enrollment' OR O_documentType_3 = 'Certificate of Enrollment') THEN O_numCopies ELSE 0 END) AS CER,
        SUM(CASE WHEN (O_documentType = 'Certificate of Graduation' OR O_documentType_2 = 'Certificate of Graduation' OR O_documentType_3 = 'Certificate of Graduation') THEN O_numCopies ELSE 0 END) AS ER,
        SUM(CASE WHEN (O_documentType = 'Certificate of Grades' OR O_documentType_2 = 'Certificate of Grades' OR O_documentType_3 = 'Certificate of Grades') THEN O_numCopies ELSE 0 END) AS TER,
        SUM(CASE WHEN (O_documentType = 'Certificate of Enrolled Semester' OR O_documentType_2 = 'Certificate of Enrolled Semester' OR O_documentType_3 = 'Certificate of Enrolled Semester') THEN O_numCopies ELSE 0 END) AS MER,
        SUM(CASE WHEN (O_documentType = 'Certificate of English Proficiency' OR O_documentType_2 = 'Certificate of English Proficiency' OR O_documentType_3 = 'Certificate of English Proficiency') THEN O_numCopies ELSE 0 END) AS SER,
        SUM(CASE WHEN (O_documentType = 'Certificate of NSTP Serial Number' OR O_documentType_2 = 'Certificate of NSTP Serial Number' OR O_documentType_3 = 'Certificate of NSTP Serial Number') THEN O_numCopies ELSE 0 END) AS SOR,
        SUM(CASE WHEN (O_documentType = 'Certificate of Honor' OR O_documentType_2 = 'Certificate of Honor' OR O_documentType_3 = 'Certificate of Honor') THEN O_numCopies ELSE 0 END) AS MOR,
        SUM(CASE WHEN (O_documentType = 'Subject Description' OR O_documentType_2 = 'Subject Description' OR O_documentType_3 = 'Subject Description') THEN O_numCopies ELSE 0 END) AS SUB,
        SUM(CASE WHEN (O_documentType = 'Authentication' OR O_documentType_2 = 'Authentication' OR O_documentType_3 = 'Authentication') THEN O_numCopies ELSE 0 END) AS AUT,
        SUM(CASE WHEN (O_documentType = 'CAV' OR O_documentType_2 = 'CAV' OR O_documentType_3 = 'CAV') THEN O_numCopies ELSE 0 END) AS CAV,
        SUM(CASE WHEN (O_documentType = 'HONOROBALE DISMISSAL' OR O_documentType_2 = 'HONOROBALE DISMISSAL' OR O_documentType_3 = 'HONOROBALE DISMISSAL') THEN O_numCopies ELSE 0 END) AS HD,
        SUM(CASE WHEN (O_documentType = 'FORM - 137' OR O_documentType_2 = 'FORM - 137' OR O_documentType_3 = 'FORM - 137') THEN O_numCopies ELSE 0 END) AS CD,
        SUM(CASE WHEN (O_documentType = 'diploma' OR O_documentType_2 = 'diploma' OR O_documentType_3 = 'diploma') THEN O_numCopies ELSE 0 END) AS Diploma,
        SUM(O_numCopies + O_numCopies_2 + O_numCopies_3) AS TOTAL_COPIES
        FROM process
        WHERE O_documentType IN ('TOR For Board Exam', 'FORM - 137', 'CAV', 'HONOROBALE DISMISSAL', 'TOR For Reference', 'Subject Description', 'Authentication', 'Certificate of Honor', 'Certificate of NSTP Serial Number', 'Certificate of English Proficiency', 'TOR For Copy School', 'Certificate of Enrolled Semester', 'Certificate of Graduation', 'Certificate of Unit Earned', 'Certificate of Grades', 'diploma', 'Certificate of Enrollment')
        GROUP BY O_ASIG";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($lastDownloadDateStr === $currentDateStr) {
                ...
                <table style="border: 1px solid black; ">
                    <tr>
                        <td style="color: white; background-color:#28A745;" colspan="20"><h2>'.$title.'</h2></td>
                    </tr>
                    <tr>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr text-align: center;>
                            <td style="border:1px solid gray;" colspan="2">' . $row["O_ASIG"] . '</td>
                        ...
                        <tr>
                            ...
                            <tr text-align: center;>
                                ...
                                <td></td>
                                    ...
                                    $output .= '
                                    <tr text-align: center;>
                                    <td colspan="5" style="color:red;">In Progress refers to document request that are currently processing. Considered as backlog.</td>
                                    </tr>
                                        ';
                    }
                    ...
                    header('Content-Disposition: attachment; filename=Generate-On Process-Document-request.xls');
                    echo $output;
                    exit;
                } else {
