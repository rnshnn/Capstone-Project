...
if (isset($_POST["btn_clicked"]) && $_POST["btn_clicked"] === "1") {
    $query = "SELECT L_ASIG,
        SUM(CASE WHEN (L_documentType = 'TOR for board exam' OR L_documentType_2 = 'TOR for board exam' OR L_documentType_3 = 'TOR for board exam') THEN L_numCopies ELSE 0 END) AS TOR,
        SUM(CASE WHEN (L_documentType = 'TOR for reference' OR L_documentType_2 = 'TOR for reference' OR L_documentType_3 = 'TOR for reference') THEN L_numCopies ELSE 0 END) AS TOR1,
        SUM(CASE WHEN (L_documentType = 'TOR for copy school' OR L_documentType_2 = 'TOR for copy school' OR L_documentType_3 = 'TOR for copy school') THEN L_numCopies ELSE 0 END) AS TOR2,
        SUM(CASE WHEN (L_documentType = 'Certificate of Unit Earned' OR L_documentType_2 = 'Certificate of Unit Earned' OR L_documentType_3 = 'Certificate of Unit Earned') THEN L_numCopies ELSE 0 END) AS CU,
        SUM(CASE WHEN (L_documentType = 'Certificate of Enrollment' OR L_documentType_2 = 'Certificate of Enrollment' OR L_documentType_3 = 'Certificate of Enrollment') THEN L_numCopies ELSE 0 END) AS CER,
        SUM(CASE WHEN (L_documentType = 'Certificate of Graduation' OR L_documentType_2 = 'Certificate of Graduation' OR L_documentType_3 = 'Certificate of Graduation') THEN L_numCopies ELSE 0 END) AS ER,
        SUM(CASE WHEN (L_documentType = 'Certificate of Grades' OR L_documentType_2 = 'Certificate of Grades' OR L_documentType_3 = 'Certificate of Grades') THEN L_numCopies ELSE 0 END) AS TER,
        SUM(CASE WHEN (L_documentType = 'Certificate of Enrolled Semester' OR L_documentType_2 = 'Certificate of Enrolled Semester' OR L_documentType_3 = 'Certificate of Enrolled Semester') THEN L_numCopies ELSE 0 END) AS MER,
        SUM(CASE WHEN (L_documentType = 'Certificate of English Proficiency' OR L_documentType_2 = 'Certificate of English Proficiency' OR L_documentType_3 = 'Certificate of English Proficiency') THEN L_numCopies ELSE 0 END) AS SER,
        SUM(CASE WHEN (L_documentType = 'Certificate of NSTP Serial Number' OR L_documentType_2 = 'Certificate of NSTP Serial Number' OR L_documentType_3 = 'Certificate of NSTP Serial Number') THEN L_numCopies ELSE 0 END) AS SOR,
        SUM(CASE WHEN (L_documentType = 'Certificate of Honor' OR L_documentType_2 = 'Certificate of Honor' OR L_documentType_3 = 'Certificate of Honor') THEN L_numCopies ELSE 0 END) AS MOR,
        SUM(CASE WHEN (L_documentType = 'Subject Description' OR L_documentType_2 = 'Subject Description' OR L_documentType_3 = 'Subject Description') THEN L_numCopies ELSE 0 END) AS SUB,
        SUM(CASE WHEN (L_documentType = 'Authentication' OR L_documentType_2 = 'Authentication' OR L_documentType_3 = 'Authentication') THEN L_numCopies ELSE 0 END) AS AUT,
        SUM(CASE WHEN (L_documentType = 'CAV' OR L_documentType_2 = 'CAV' OR L_documentType_3 = 'CAV') THEN L_numCopies ELSE 0 END) AS CAV,
        SUM(CASE WHEN (L_documentType = 'HONOROBALE DISMISSAL' OR L_documentType_2 = 'HONOROBALE DISMISSAL' OR L_documentType_3 = 'HONOROBALE DISMISSAL') THEN L_numCopies ELSE 0 END) AS HD,
        SUM(CASE WHEN (L_documentType = 'FORM - 137' OR L_documentType_2 = 'FORM - 137' OR L_documentType_3 = 'FORM - 137') THEN L_numCopies ELSE 0 END) AS CD,
        SUM(CASE WHEN (L_documentType = 'diploma' OR L_documentType_2 = 'diploma' OR L_documentType_3 = 'diploma') THEN L_numCopies ELSE 0 END) AS Diploma,
        SUM(L_numCopies + L_numCopies_2 + L_numCopies_3) AS TOTAL_COPIES
        FROM releasing
        WHERE L_documentType IN ('TOR For Board Exam', 'FORM - 137', 'CAV', 'HONOROBALE DISMISSAL', 'TOR For Reference', 'Subject Description', 'Authentication', 'Certificate of Honor', 'Certificate of NSTP Serial Number', 'Certificate of English Proficiency', 'TOR For Copy School', 'Certificate of Enrolled Semester', 'Certificate of Graduation', 'Certificate of Unit Earned', 'Certificate of Grades', 'diploma', 'Certificate of Enrollment')
        GROUP BY L_ASIG";
                ...
                <table style="border: 1px solid black; ">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr text-align: center;>
                            <td style="border:1px solid gray;" colspan="2">' . $row["L_ASIG"] . '</td>
                        ...
                        <tr>
                            ...
                            <tr text-align: center;>
                                ...
                                <td></td>
                                    ...
                                    $output .= '
                                    <tr text-align: center;>
                                    <td colspan="5" style="color:red;">This request is ready to release.</td>
                                    </tr>
                                        ';
                    }
                    ...
                    header('Content-Disposition: attachment; filename=Generate-Releasing-Document-request.xls');
                    echo $output;
                    exit;
                } else {
