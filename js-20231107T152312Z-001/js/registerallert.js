document.getElementById("registerButton").addEventListener("click", function(event) {
    ...
    const requiredFields = [
        "R_EMAIL", "R_PASS", "R_CPASS", "R_FULL", "R_FIRST", "R_MIDD", "R_COU", "R_YEAR", "R_CON", "R_ADD", "R_STRE", "R_BRGY", "R_MUNI", "R_CITY", "R_IMG"
    ];
    ...
    if (!hasMissingFields) {
        ...
        Swal.fire({
            title: "Register!",
            text: "Are you sure you want to submit the registration?",
            icon: "warning",
