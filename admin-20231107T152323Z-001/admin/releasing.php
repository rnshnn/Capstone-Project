...
<head>
    ...
    <title>RMS - Admin releasing</title>
</head>
    ...
    <div style="flex: 1; display: flex;">
        <nav class="col-md-3 col-lg-2 d-md-block bg-light border-right" id="sidebar">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="Releasing" class="list-group-item list-group-item-action active">
        ...
        <main role="main" class="col-md-9 ml-md-auto col-lg-10 px-1">
            <div class="container-fluid">
                <div class="mt-5">
                    <h3 class="mb-4"> <i class="fas fa-hourglass-start mr-2"></i> Releasing Request</h3>
                ...
                ?>
                    ...
                    <div class="input-group mb-3">
                        <form action="" method="GET" class="w-50 d-flex align-items-center">
                            ...
                            <select type="text" name="search" class="form-control flex-grow-1 mr-1"
                                ...
                                <?php
                            $query = "SELECT DISTINCT L_ASIG FROM releasing";
                            $result = mysqli_query($conn, $query);

                            if ($result) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    $L_ASIG = $row['L_ASIG'];
                                    echo "<option value='$L_ASIG'>$L_ASIG</option>";
                                }
                            } else {
                        ...
                        <form action="../php/admin/releasing_report" method="Post"
                            class="d-flex align-items-center ml-auto" id="form_release">
                    ...
                    if (isset($_GET['search'])) {
                        ...
                        $query = "SELECT * FROM releasing WHERE L_ASIG LIKE '%$search%'";
                    } else {
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($users = mysqli_fetch_assoc($result)) {
                            ...
                            <tr data-toggle="modal" data-target="#recordModal<?= $i; ?>">
                                ...
                                <td><?= $users['L_COU'] ?></td>
                                <td><?= $users['L_YEAR'] ?></td>
                                <td><?= $users['L_documentType'] ?> <br> <?= $users['L_documentType_2'] ?> <br>
                                    <?= $users['L_documentType_3'] ?></td>
                                <td><?= $users['L_numCopies'] ?> <br> <?= $users['L_numCopies_2'] ?> <br>
                                    <?= $users['L_numCopies_3'] ?></td>
                                <td><?= $users['L_price'] ?></td>
                                <td><?= $users['L_CODE'] ?></td>
                                <td style="color: darkgreen;"><?= $users['L_ASIG'] ?></td>
